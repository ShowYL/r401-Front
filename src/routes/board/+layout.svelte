            ...
            <nav class="flex flex-col items-center justify-between h-full">
                ...
                <ul class="list-none m-0 p-0 flex flex-col h-1/2">
                    <li class="flex items-center my-2 mx-4">
                        <a href="/board/accueil" class="nav-button flex items-center bg-gray-800 text-white p-2 rounded cursor-pointer no-underline h-1/2"
                    ...
                    <li class="flex items-center my-2 mx-4">
                        <a href="/board/joueur" class="nav-button flex items-center bg-gray-800 text-white p-2 rounded cursor-pointer no-underline h-1/2"
                        data-sveltekit-reload>
                            <div class="vertical-hr bg-gray-600 h-3/2 w-1 mr-3 hidden rounded"></div>
                    ...
                    <li class="flex items-center my-2 mx-4">
                        <a href="/board/match" class="nav-button flex items-center bg-gray-800 text-white p-2 rounded cursor-pointer no-underline h-1/2"
                        data-sveltekit-reload>
                            <div class="vertical-hr bg-gray-600 h-3/2 w-1 mr-3 hidden rounded"></div>
                    ...
                    <li class="flex items-center my-2 mx-4">
                        <a href="/board/selection" class="nav-button flex items-center bg-gray-800 text-white p-2 rounded cursor-pointer no-underline h-1/2"
                        data-sveltekit-reload>
                            <div class="vertical-hr bg-gray-600 h-3/2 w-1 mr-3 hidden rounded"></div>
